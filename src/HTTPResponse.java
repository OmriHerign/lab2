...
public class HTTPResponse extends HTTPMessage {
	 ...
	 * @throws Exception 
	 */
	String generateMain_HTML(String loggedUsername) throws Exception {
		
		StringBuilder out = new StringBuilder();

		out.append("<html>");
		out.append("<body>");
		out.append("<center><h1>Main page</h1><br>");
		out.append("Logged username is: <font color=\"orange\">" + loggedUsername + "</font><br>");
		out.append("<a href=\"logout.html?id=fornocache\">Logout</a><br><br>");
		out.append("<h3>Menu:</h3>");
		out.append("<a href=\"reminders.html\">E-Mail reminders</a><br>");
		out.append("<a href=\"tasks.html\">Tasks</a><br>");
		out.append("<a href=\"polls.html?bla\">Polls</a><br><br>");
		
		out.append("<h3>Active Users</h3>");
		ConcurrentHashMap<String, String> users = ActiveUsers.getInstance().getAllLoggedusers();
		for (Entry<String,String> entry : users.entrySet()) {
			out.append("<b> Username: </b>" + entry.getKey() + " <b>Logged-in From: </b>" + entry.getValue() + "<br>");
		}

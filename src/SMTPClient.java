...
public class SMTPClient {
	 ...
	 * 
	 */
	public boolean SendMail(String mailFrom, String mailTo, String subject, String body) {
	 ...
	 * @throws IOException
	 */
	private void RCTP_TO(String rcptTo) throws Exception, IOException {
	 ...
	 * @throws IOException
	 */
	private void MAIL_FROM(String mailFrom) throws Exception, IOException {
	 ...
	 * @throws IOException
	 */
	private void DATA(String subject, String mailTo, String body) throws Exception, IOException {
		sendSmtpCommand("DATA");
		getSmtpResponse();
		
		// append html headers
		sendSmtpCommand("MIME-Version: 1.0;");
		sendSmtpCommand("Content-type: text/html;");
		
		// Mail data
		sendSmtpCommand("Subject: " + subject);
		sendSmtpCommand("From: Mr.Tasker");
		sendSmtpCommand("To: " + mailTo + CRLF);
		
		// Mail body
		sendSmtpCommand(body);
